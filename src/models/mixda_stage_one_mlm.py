...
class MixDAStageOneMLM(LightningModule):
    ...
    def add_model_specific_args(parent_parser):
        ...
        parser.add_argument(
            "--dirpath", type=str, default="test"
        )
        parser.add_argument(
            "--knowledge_data_path",
            type=str,
            default="datasets/knowledge/train.json",
        )
        ...
        parser.add_argument("--model_name", type=str, default="/data/weiguang/roberta-large")
        parser.add_argument(
            "--model_checkpoint",
            type=str,
            default="",
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.tokenizer.model_max_length = 512 ## added as we initialized the tokenizer from local folder
    ...
    def train_dataloader(self, shuffle=False):
        def map_dataset(x):
            if len(x['targets']) != 0:group_texts
